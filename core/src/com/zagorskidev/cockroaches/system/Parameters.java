...
public class Parameters {
	...
	public static final float X_FIELDS = 300;
	public static final float COCKROACH_RADIUS = GAME_WIDTH / X_FIELDS;
	public static final float Y_FIELDS = GAME_HEIGHT == GAME_WIDTH ? X_FIELDS : (int)(GAME_HEIGHT / COCKROACH_RADIUS);
	
	public static final float X_SPAWN = (int)(X_FIELDS * 0.25);
	public static final float Y_SPAWN = (int)(Y_FIELDS * 0.25);
	
	public static final float X_ESCAPE = (int)(X_FIELDS * 0.8);
	public static final float Y_ESCAPE = (int)(Y_FIELDS * 0.8);
	public static final float ESCAPE_THRESHOLD = (int)(X_FIELDS * 0.1);
	
	public static final float HIT_THRESHOLD = 0;
	...
	public static final float MAX_RECESSIVE_PAIR_DISTANCE = 10;
